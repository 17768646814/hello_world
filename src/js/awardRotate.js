(function () {
    ...
    window.Turntable = {
        rotate: function (element, parameters) {
            if (element.length === 0 || typeof parameters == "undefined") return;
            if (typeof parameters == "number") parameters = {angle: parameters};
            if (!element.Wilq32 || !element.Wilq32.PhotoEffect) {
                var paramClone = {};
                for (var i in parameters) {
                    paramClone[i] = parameters[i];
                }
                new Wilq32.PhotoEffect(element, paramClone)._rootObj;
            } else {
    ...
    Wilq32.PhotoEffect = (function () {
        if (supportedCSS) {
            return function (img, parameters) {
                ...
                img.getRotateAngle = function () {
                    if (this.Wilq32 && this.Wilq32.PhotoEffect) {
                        return this.Wilq32.PhotoEffect._angle;
                    }
                }
                img.stopRotate = function () {
                    if (this.Wilq32 && this.Wilq32.PhotoEffect) {
            ...
            if (events && this._eventObj) {
                if (this._parameters.bind) {
                    ...
                    for (var a in oldEvents) {
                        if (oldEvents.hasOwnProperty(a)) {
                            this._eventObj.addEventListener(a, oldEvents[a])
                        }
                    }
                }
                ...
                for (var a in events) {
                    if (events.hasOwnProperty(a)) {
                        this._eventObj.addEventListener(a, events[a])
                    }
                }
            }
        },
